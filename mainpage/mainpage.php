            ...
            <li class="toHover1">Artists
                <ul class="hide1">
                    <li class="toHover1-1">Christopher Larkin
                        <ul class="hide1-1">
                            <li><a href="vinyl1.html" >Hornet</a><form action="test.php" method="POST"><button type="submit" name="songButton" value="9">Look</button></form></li>
                            <li><a href="vinyl2.html">Dung Defender</a><form action="test.php" method="POST"><button type="submit" name="songButton" value="10">Look</button></form></li>
